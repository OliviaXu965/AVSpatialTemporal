...
out1FileName            = ['BimodalLocalization_pre_practice_sub',... 
    num2str(ExpInfo.subjID),'_session', num2str(ExpInfo.session)]; %create file name
...
VSinfo.temporalOffset   = [-300,-150,0,150,300]; %ms, relative to A (only 3 levels are chosen for the practice)
...
BimodalLocalization_pre_practice_data = {ExpInfo, ScreenInfo, VSinfo, ...
    AudInfo, Response};
save(out1FileName,'BimodalLocalization_pre_practice_data');
Screen('CloseAll');
