...
out1FileName            = ['BimodalLocalization_V1AV2_practice_sub',... 
...
BimodalLocalization_V1AV2_practice_data = {ExpInfo, ScreenInfo, VSinfo, ...
    AudInfo, Response};
save(out1FileName,'BimodalLocalization_V1AV2_practice_data');
Screen('CloseAll');
